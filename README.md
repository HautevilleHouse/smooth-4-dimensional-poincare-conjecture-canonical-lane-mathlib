# Smooth 4 Dimensional Poincare Conjecture — Canonical Lane Mathlib
...
```bash
git clone https://github.com/HautevilleHouse/smooth-4-dimensional-poincare-conjecture-canonical-lane-mathlib.git
cd smooth-4-dimensional-poincare-conjecture-canonical-lane-mathlib
lake exe
lake build
```
